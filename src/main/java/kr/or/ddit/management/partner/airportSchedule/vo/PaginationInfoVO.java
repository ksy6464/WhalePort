...
public class PaginationInfoVO<T> {
	...
	private String scStd;
	private String scAirline;
	...
	public void setCurrentPage(int currentPage) {
		...
		// 마지막페이지 = (현재 페이지 + (페이지 블록 사이즈 - 1)) / 페이지 블록 사이즈 * 페이지 블록 사이즈
		// '/ blockSize * blockSize는 1,2,3,4,5.. 페이지마다 실수가 아닌 정수 계산을 이용해 endPage를 구하기 위함
	...
	public String getPagingHTML() {
		...
		// endPage만큼 반복되고 넘어가야할 페이지가 존재하지 않는 상태라면 마지막 페이지가 포함되어 있는 block 영역이므로
		// totalPage만큼 반복됩니다.
