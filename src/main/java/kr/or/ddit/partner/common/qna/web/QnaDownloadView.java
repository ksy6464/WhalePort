...
public class QnaDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		Map<String, Object> qnaFileMap = (Map<String, Object>) model.get("qnaFileMap");
		
		File saveFile = new File(qnaFileMap.get("fileSavepath").toString());
		String filename = qnaFileMap.get("fileRealname").toString();
		...
		response.setHeader("Content-Length", qnaFileMap.get("fileSize").toString());
