	  ...
	  <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">이벤트 ${name }</h4>
		...
		<div class="card">
			<div class="card-body">
				<form action="/partner/event/register" class="mt-0" method="post" id="eventForm" enctype="multipart/form-data" novalidate>
					<c:if test="${status eq 'u' }">
...
$(function(){
	...
	addBtn.on("click", function(){
		...
		if($(this).val()=="수정"){
			eventForm.attr("action", "/partner/event/update");
		}
