...
/*       width:350px; height:500px; border:1px solid black;background-color:yellow;display:none; */
      width:350px; height:550px;  display:none;
  }
...
<!--           <div class="title_area">레이어 팝업 오늘 하루 이창을 열지 않음</div> -->
          ...
          <c:choose>
          	<c:when test="${not empty popImg }">
          	 <c:set var="popImgPath" value="${popImg }" />
          	</c:when>
          	<c:otherwise>
          	 <c:set var="popImgPath" value="${pageContext.request.contextPath }/resources/assets/images/airport/pokemon.jpg" />
          	</c:otherwise>
          </c:choose>
          <img alt="modernize-img" src="${popImgPath }" style="width:350px; height:500px;">
