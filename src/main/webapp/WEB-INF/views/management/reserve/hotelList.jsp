...
<div class="body-wrapper">
        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
           <div class="card-body px-4 py-3">
             <div class="row align-items-center" style="margin-top:20px;">
               <div class="col-9">
                 <h4 class="fw-semibold mb-8">호텔</h4>
                 <nav aria-label="breadcrumb">
                   <ol class="breadcrumb">
                     <li class="breadcrumb-item">
                       <a class="text-muted text-decoration-none" href="/common/home">DashBoard</a>
                     </li>
                     <li class="breadcrumb-item" aria-current="page">호텔</li>
                   </ol>
                 </nav>
               </div>
               <div class="col-3">
    ...
    <div class="col-md-9 d-flex justify-content-end align-items-center">
		...
		<form action="/management/reserve/excelHotelDown" method="post" id="excelDownForm">
...
<!--                             <th><h6 class="fs-4 fw-semibold mb-0">상세보기</h6></th> -->
                                            ...
                                            <td>
                                                <c:choose>
                                                    ...
                                                    <c:when test="${hr.hrStatus == 'Y'}">
                                                        <span class="badge bg-primary-subtle text-primary btn2" style="margin-left:10px" data-action="approve" data-hrno="${hr.hrNo }">예약완료</span>
                                                    </c:when>
                                                </c:choose>
                                            </td>
                                        </tr>
            ...
            <input type="submit" class="btn btn-primary" value="엑셀 다운로드" id="excelDownBtn" />
				...
				<form method="post" action="/management/reserve/hotelStatus" id="hotelStatus">
    ...
    $('.btn2').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
            	var hrHtml = "<input type='text' name='hrNo' value='" + hrN + "' />";
            	$('#hotelStatus').append(hrHtml);
            	$('#hotelStatus').submit();
            	
            	
//                 $.ajax({
//                     url: '/management/reserve/hotelStatus',
//                     method: 'POST',
//                     data: {
//                         hrNo: '${hotelVO.hrNo}',
//                         hrStatus: 'N'
...
//                             'success'
//                         ).then(() => {
//                             $('#hotelStatus').html('<span class="badge bg-primary-subtle text-primary" style="margin-left:10px" id="btn2" data-action="approve">예약완료</span>');
...
// //                             $('#btn3').removeAttr('id').removeAttr('data-bs-toggle data-bs-target').text('아이디 발급').attr('id', 'idBtn').removeClass().addClass('btn bg-secondary-subtle text-secondary border-0');
