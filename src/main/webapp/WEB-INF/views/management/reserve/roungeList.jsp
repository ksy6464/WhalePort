        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
           <div class="card-body px-4 py-3">
             <div class="row align-items-center" style="margin-top:20px;">
               <div class="col-9">
                 <h4 class="fw-semibold mb-8">라운지</h4>
                 <nav aria-label="breadcrumb">
                   <ol class="breadcrumb">
                     <li class="breadcrumb-item">
                       <a class="text-muted text-decoration-none" href="/common/home">DashBoard</a>
                     </li>
                     <li class="breadcrumb-item" aria-current="page">라운지</li>
                   </ol>
                 </nav>
               </div>
               <div class="col-3">
        ...
        <div class="card w-100 position-relative overflow-hidden">
			...
			<!-- 상태별 카운트 위젯 끝 -->
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-md-3">
                        <form id="filter-form" action="/management/reserve/roungeList" method="get">
               ...
               <div class="col-md-9 d-flex justify-content-end align-items-center" >
                   <form action="/management/reserve/roungeList" method="get" class="position-relative me-2" id="search-form">
                ...
                <table class="table text-nowrap mb-0 align-middle" style="table-layout: fixed;">
                    ...
                    <tbody>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${pagingVO.dataList}" var="rr" varStatus="status">
                                    <c:if test="${rr.rrStatus == selectedItem or empty selectedItem}">
                                        <tr>
                                            <td><p class="mb-0 fw-normal fs-4">${rr.rrNo}</p></td>
											<td><p class="mb-0 fw-normal fs-4">${rr.rgName}</p></td>
											<td><p class="mb-0 fw-normal fs-4">${rr.rrName}</p></td> 
											<td><p class="mb-0 fw-normal fs-4">${rr.rrTel}</p></td> 
											<td><p class="mb-0 fw-normal fs-4">${rr.rrCount}</p></td> 
           ...
           <input type="submit" class="btn btn-primary" value="엑셀 다운로드" id="excelDownBtn" />
                ...
                <div class="text-end mb-3">
                    <c:if test="${not empty searchWord}">
                        <a href="/management/reserve/roungeList" class="btn btn-outline-primary me-3">목록</a>
                    </c:if>
                </div>
