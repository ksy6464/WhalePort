    ...
    <div class="container-fluid">
					        ...
					        <c:otherwise>
					            ...
					            <c:forEach items="${pagingVO.dataList}" var="schedule" varStatus="status">
					                <tr>
					                    ...
					                    <td><p class="mb-0 fw-normal fs-4">${schedule.inReception}</p></td>
		    ...
		    <div class="text-end mb-3">
			    <c:choose>
			        ...
			        <c:otherwise>
			        	<a class="btn btn-primary" href="javascript:void(0);" data-bs-target="#scheduleRegister" data-bs-toggle="modal" onclick="return false;">일정 등록</a>
